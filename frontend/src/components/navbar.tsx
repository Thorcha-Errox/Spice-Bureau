        ...
        <div className="flex justify-between items-center w-full px-4 md:px-6 h-16 gap-3">
          <div className="flex items-center gap-3 flex-1 min-w-0">
            ...
            {isHomePage && !portalName && (
              <div className="flex-[3] flex max-w-[220px] sm:max-w-3xl items-center bg-[#F1F3F5] rounded-full px-2 md:px-4 py-1.5 md:py-2 gap-1 md:gap-2 border border-transparent focus-within:border-primary/20 focus-within:bg-white focus-within:shadow-md transition-all min-w-0">
                <Link
                  to="/address"
                  className="flex-[1] min-w-0 flex items-center gap-1 cursor-pointer hover:bg-white/30 rounded-full px-2 md:px-3 transition-colors group/loc"
                >
                  <span className="material-symbols-outlined text-primary text-[16px] md:text-[22px] flex-shrink-0">
                    location_on
                  </span>
                  <div className="flex flex-col leading-none overflow-hidden hidden md:flex">
                    <span className="text-[10px] text-on-surface-variant font-bold uppercase tracking-tight whitespace-nowrap">
                      Current Location
                    </span>
                    <span className="text-label-md text-on-surface truncate max-w-[150px] font-semibold">
                      {city || "Select"}
                    </span>
                  </div>
                  <span className="text-[10px] font-bold text-on-surface truncate md:hidden">
                    {city || "Location"}
                  </span>
                </Link>
